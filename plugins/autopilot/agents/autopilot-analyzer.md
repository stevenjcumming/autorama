...
### When Analysis Passes Clean

If no issues are found:

**File**: `{SPEC_DIR}/artifacts/signals/{timestamp}_approval_analysis_clean.md`
...
## Signal: Clean Analysis Run

### What Triggered This Signal
Static analysis completed with no issues.

### Agent Behavior
Ran {N} analysis commands, all passed clean.

### Observed Outcome
Code meets static analysis standards.

### Potential Improvement
Current coding patterns are working well.
```

### When Same Rule Repeatedly Violated

**File**: `{SPEC_DIR}/artifacts/signals/{timestamp}_correction_repeated_violation.md`
...
## Signal: Repeated Rule Violation

### What Triggered This Signal
Rule `{rule}` was violated {count} times in this session.

### Agent Behavior
Coder is not following {rule} guideline.

### Observed Outcome
Multiple fixes will be required.

### Potential Improvement
- Add `{rule}` to coding guidelines
- Consider adding to pre-commit hook
- Update skill files with this pattern
